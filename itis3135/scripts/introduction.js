// 1. Define functions FIRST to satisfy the linter's top-to-bottom reading requirement
function processForm(e) {
    ...
    // Added parentheses around (entry)
...
// 2. Event Listeners go at the BOTTOM after everything is defined
